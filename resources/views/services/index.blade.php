    ...
    <div class="container-site">
        ...
        <div class="grid md:grid-cols-3 gap-4">
            <div class="rounded-2xl border border-rule bg-surface p-8 card-hover">
                ...
                <a href="{{ route('book') }}" class="mt-8 inline-flex items-center gap-2 text-sm text-lift">Book an audit <span aria-hidden="true">↗</span></a>
            </div>
            <div class="rounded-2xl border border-rule bg-surface p-8 card-hover">
                ...
                <a href="{{ route('book') }}" class="mt-8 inline-flex items-center gap-2 text-sm text-pop">Talk to a senior operator <span aria-hidden="true">↗</span></a>
            </div>
            <div class="rounded-2xl border border-rule bg-surface p-8 card-hover">
                ...
                <a href="{{ route('book') }}" class="mt-8 inline-flex items-center gap-2 text-sm text-heat">Book a strategy call <span aria-hidden="true">↗</span></a>
            </div>
        </div>
    </div>
</section>
